...
const FlexNaira = () => {
    ...
    const data = {
        amt: account.flexnaira_amt || 0.00,
        body: [
            {
                name:"FlexNaira Wallet",link:"/dashboard/savings/flexnaira/wallet/*",
                svg: 
                <svg stroke="currentColor" fill="none" strokeWidth="2" style={{color: "rgb(231,67,156)"}} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="mb-1 md:mb-0 mr-0 md:mr-4 text-lg md:text-2xl" height="20px" width="20px" xmlns="http://www.w3.org/2000/svg">
                    <line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line>
                </svg>
            },
            {
                name:"Info",link:"/dashboard/savings/flexnaira/info",
                svg: 
                <svg stroke="currentColor" fill="none" strokeWidth="2" style={{color: "rgb(231,67,156)"}} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="mb-1 md:mb-0 mr-0 md:mr-4 text-lg md:text-2xl" height="20px" width="20px" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='savings_content'>
                    <div className='savings_header'>
                        <div className='header_top'>
                            <h1 style={{color:"rgb(231,67,156)"}}>FlexNaira</h1>
                        ...
                        <div className="savings_navbar">
                            <ul className='navbar_lists'>
                                {Nav.map((val,idx) => (
                                    <li className='navbar_list' key={idx} style={{borderBottom: idx==1?val.border:"none"}}>
                                        <Link to={val.link} className="navbar_links" style={{textDecoration: 'none'}}>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill={idx==1?val.color:"#e2e8f0"} xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span style={{color: idx==1?"black":"#718096"}}>{val.name}</span>
                                        </Link>
                                    </li>
                                ))}
                            </ul>
                    ...
                    <div className="piggybank">
                        <Balance Data={data} color={"rgb(231,67,156)"} />
                            ...
                            <div className="piggybank_top">
                                ...
                                <div className="piggybank_lists">
                                    <Link to="#"
                                     ...
                                     style={{textDecoration: "none", background: (select=="all")?"rgb(231,67,156)":"none", color: (select=="all")?"white":"black"}}>
                                        All
                                    </Link>
                                    <Link to="#"
                                     className="piggybank_links" 
                                     ...
                                     onMouseLeave={() => setSelect(null)}
                                     style={{textDecoration: "none", background: (select=="credit")?"rgb(231,67,156)":"none", color: (select=="credit")?"white":"black"}}>
                                        Credit
                                    </Link>
                                    <Link to="#"
                                     className="piggybank_links" 
                                     ...
                                     onMouseLeave={() => setSelect(null)}
                                     style={{textDecoration: "none", background: (select=="debit")?"rgb(231,67,156)":"none", color: (select=="debit")?"white":"black"}}>
                                        Debit
                                    </Link>
                                </div>
                            </div>
                            <NoTransactions type={"flexnaira"} />
                        </div>
                    </div>
                </div>
            </div>
