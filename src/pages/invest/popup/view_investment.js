...
const ViewInvestment = () => {
    ...
    const data = store.find(val => {
        return val.id == params.id && val.type == "investment";
    })
    const Desc = {
    ...
    return (
        <div className="popup_container" style={{ zIndex: "1000" }}>
            ...
            <div className="popup_main">
                <Slider zIndex={1000} leave={leave}>
                    ...
                    <div className="popup_body">
                        ...
                        <div className="extra">
                            <span className="med_txxt">EXTRA INFORMATION</span>
            ...
            <Routes>
                <Route path="about" element={<About data={Desc} name={name}/>} />
